# Design System — AdobeXD

## Current direction

Use the existing visual identity as evidence, then converge on a modern, premium, minimal, calm language appropriate to a digital product. Avoid generic admin-template styling, excessive cards, gradients, shadows, radii, oversized type, and arbitrary decoration.
