# Product Foundation — AdobeXD

## Evidence and scope

This foundation is based on the repository structure, package metadata, and available README. The detected implementation is **static or legacy web**, and the product is treated as a **digital product**. Unknown business facts remain explicit assumptions and must be validated before feature work.
...
- Discoverability and efficiency of the primary journey appropriate to a digital product.
